...
class TaskTest < ActiveSupport::TestCase
  ...
  test "next step of a task with a single child returns the child" do
    task = TaskBuilder.new.with_default_title.with_user.with_user.build
    child = TaskBuilder.new.with_default_title.with_user.with_parent(task).save
  ...
  test "next step with multiple children returns the last child" do
    task = TaskBuilder.new
            ...
            .with_user
            .build
    first_child = TaskBuilder.new
                    .with_default_title
                    .with_user
                    .with_parent(task)
                    .completed
                    .save
    second_child = TaskBuilder.new
                    .with_default_title
                    .with_user
                    .with_parent(task)
                    .save
  ...
  test "next step of task with child hierarchy returns last child" do
    task = TaskBuilder.new.with_default_title.with_user.build
    child = TaskBuilder.new.with_default_title.with_user.with_parent(task).save
    grandchild = TaskBuilder.new.with_default_title.with_user.with_parent(child).save
  ...
  test "next step of task with child hierarchy returns last uncompleted child" do
    task = TaskBuilder.new.with_default_title.with_user.build
    child = TaskBuilder.new.with_default_title.with_user.with_parent(task).save
    grandchild = TaskBuilder.new.with_default_title.with_user.with_parent(child).completed.save
  ...
  test "last_uncompleted_child finds last child which is uncompleted" do
    task = TaskBuilder.new.with_default_title.with_user.build
    first_child = TaskBuilder.new.with_default_title.with_user.with_parent(task).save
    second_child = TaskBuilder.new.with_default_title.with_user.with_parent(task).completed.save
